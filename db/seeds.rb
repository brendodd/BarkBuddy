...
buddy = Dog.create!(name: "Buddy", birthday: "2018-05-17", size: "Large", breed: "Great Dane", address: "Amsterdam-Oost", user: tom)
mutley = Dog.create!(name: "Mutley", birthday: "2017-06-25", size: "Small", breed: "Chihuahua", address: "Amsterdam-Zuid", user: tom)
duke = Dog.create!(name: "Duke", birthday: "2016-07-30", size: "Medium", breed: "Cockapoo", address: "Amsterdam-Noord", user: tom)
smokey = Dog.create!(name: "Smokey", birthday: "2020-10-", size: "Small", breed: "Pug", address: "Utrecht", user: tom)
